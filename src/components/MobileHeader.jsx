...
const MobileHeader = ({ name, address }) => {
      ...
      >
        <Toolbar sx={{ px: 1, padding: 0, alignSelf: 'anchor-center' }}>
          <IconButton edge="start" color="inherit" aria-label="back">
            <img src="/food-truck.png" alt="Food Truck" style={{ width: 28, height: 25, padding: 0 }} />
          </IconButton>
          ...
          >
            <img src="/history-book.png" alt="history-book" style={{ width: 25, height: 30, padding: 0 }} />
          </IconButton>
        </Toolbar>
      </AppBar>
