...
const MobileDishCard = ({ item, addToCart, isInCart, removeFromCart, discountPercent, isMobile,  cart, updateCartItemQuantity }) => {
      ...
      <CardContent sx={{ p: 2 }}>
        <Box sx={{ display: 'flex', gap: 2 }}>
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {/* {item.half_price > 0 ? `Half: ¥${item.half_price} | Full: ¥${item.full_price}` : `Price: ¥${item.full_price}`} */}
            </Typography>
